...
interface GameState {
  ...
  worldCreation: {
    ...
    mcData: {
      ...
      innerSecret: string;
      relationships: Array<{ name: string; relation: string; status?: string; impression?: string; termsOfAddress?: string[]; description: string }>;
      loveViews: string;
      experience: string;
...
export const useStore = create<GameState>()(
  persist(
    immer((set) => ({
      ...
      setUseColorEnabled: (enabled) => set((state) => {
