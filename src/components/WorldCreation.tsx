...
export default function WorldCreation() {
  ...
  const handleAIGenField = async (fieldName: string, fieldKey: keyof typeof worldData) => {
    if (!initialIdea.trim()) {
    ...
    try {
      ...
      for await (const chunk of result) {
        if (chunk.text) {
          fullText += chunk.text;
          const cleanText = fullText.replace(/<THINKING_PROCESS>[\s\S]*?<\/THINKING_PROCESS>/g, '').replace(/```[\s\S]*?```/g, '').trimStart();
          updateWorldCreation(draft => { 
            // @ts-ignore
                  ...
                  <div className="space-y-8">
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        variant="title"
                        onAIGen={() => handleAIGenField("TÊN TRÒ CHƠI / TÊN CÂU CHUYỆN", "name")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onChange={(val) => setWorldData({...worldData, difficulty: val})}
                        ...
                        onAIGen={() => handleAIGenField("ĐỘ KHÓ", "difficulty")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onAIGen={() => handleAIGenField("BỐI CẢNH", "background")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onAIGen={() => handleAIGenField("MỐC THỜI GIAN MỞ ĐẦU", "starterTimeline")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onAIGen={() => handleAIGenField("KỊCH BẢN MỞ ĐẦU", "starterScenario")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onAIGen={() => handleAIGenField("QUY TẮC THẾ GIỚI", "worldRules")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onAIGen={() => handleAIGenField("QUY TẮC ĐẶT TÊN", "namingConventions")}
                    ...
                    <section className="space-y-4">
                      <CharacterInput
                        ...
                        onAIGen={() => handleAIGenField("THỂ LOẠI", "genre")}
                    ...
                    <section className="space-y-4">
                      <CharacterInput
                        ...
                        onAIGen={() => handleAIGenField("ÂM HƯỞNG CHỦ ĐẠO", "mainMood")}
                    ...
                    <section className="space-y-4">
                      <CharacterInput
                        ...
                        onAIGen={() => handleAIGenField("NHỊP ĐỘ", "pacing")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onAIGen={() => handleAIGenField("ĐỊA LÝ & VÙNG LÃNH THỔ", "geography")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onAIGen={() => handleAIGenField("LỊCH SỬ THẾ GIỚI", "worldHistory")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onAIGen={() => handleAIGenField("VĂN HÓA & PHONG TỤC", "culture")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onAIGen={() => handleAIGenField("KINH TẾ & XÃ HỘI", "economy")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onAIGen={() => handleAIGenField("TÔN GIÁO & TÍN NGƯỠNG", "religion")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onAIGen={() => handleAIGenField("CÁC QUỐC GIA & THẾ LỰC", "factions")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onAIGen={() => handleAIGenField("MỐI QUAN HỆ GIỮA CÁC THẾ LỰC", "factionRelations")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onAIGen={() => handleAIGenField("CÁC YẾU TỐ ĐỘC ĐÁO", "uniqueElements")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onAIGen={() => handleAIGenField("HỆ THỐNG SỨC MẠNH", "powerSystem")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onAIGen={() => handleAIGenField("KIỂM SOÁT LOGIC", "logicControl")}
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        onAIGen={() => handleAIGenField("VĂN PHONG", "writingStyle")}
                    ...
                    <section className="space-y-4">
                      <CharacterInput 
                        ...
                        onAIGen={() => handleAIGenField("NGÔI KỂ", "narrativePerspective")}
                        isGenerating={generatingFields["narrativePerspective"]}
                ...
                <div className="space-y-12">
                      ...
                      <div className="space-y-10">
                        ...
                        >
                          ...
                          <div className="space-y-4">
                             ...
                             <CharacterTextArea label="MIÊU TẢ LITE (TÓM TẮT NGOẠI HÌNH)" value={npc.appearanceLite || ''} onChange={(val) => { const n = [...npcs]; n[idx] = { ...n[idx], appearanceLite: val }; setNpcs(n); }} placeholder="Tóm tắt ngắn gọn ngoại hình của NPC để AI dễ ghi nhớ..." rows={3} />
                             ...
                             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-4 col-span-1 md:col-span-2">
                                  <div className="flex flex-col gap-4">
                                    <CharacterTextArea label="SỞ THÍCH, GHÉT, NỖI SỢ (SFW)" value={npc.preferences?.sfw || ''} onChange={(val) => { const n = [...npcs]; n[idx] = { ...n[idx], preferences: { ...n[idx].preferences, sfw: val, nsfw: n[idx].preferences?.nsfw || '' } }; setNpcs(n); }} placeholder="Ví dụ: Thích hoa, ghét cá, sợ bóng tối..." />
                                    <CharacterTextArea label="SỞ THÍCH, GHÉT, NỖI SỢ (NSFW) [TÙY CHỌN]" value={npc.preferences?.nsfw || ''} onChange={(val) => { const n = [...npcs]; n[idx] = { ...n[idx], preferences: { ...n[idx].preferences, sfw: n[idx].preferences?.sfw || '', nsfw: val } }; setNpcs(n); }} placeholder="Ví dụ: Thích bị cắn, ghét bạo lực quá mức, sợ..." />
                                  </div>
                                </div>
                             </div>
                          </div>
                  ...
                  <button 
                    onClick={() => setNpcs([...npcs, { 
                      name: '', fullName: '', titles: '', occupation: '', gender: '', age: '', dob: '', height: '', weight: '', measurements: '', appearance: '', appearanceLite: '', background: '', rank: '', powers: [], skills: [], role: '', personality: '', personalityCore: '', philosophy: '', distinguishingFeatures: '', innerSecret: '', relationships: [], loveViews: '', experience: '', nsfwPersonality: '', nsfwReactions: '', literaryDescription: '', goal: '', preferences: { sfw: '', nsfw: '' }
                    }])}
...
function CharacterInput({ label, value, onChange, placeholder, onAIGen, isGenerating, description }: { label: string; value: string; onChange: (val: string) => void, placeholder?: string, onAIGen?: () => void, isGenerating?: boolean, description?: string }) {
  const theme = useStore(state => state.theme);
  ...
  return (
    <div className="space-y-2">
      <div className="flex flex-col gap-1.5 mb-1">
        <div className="flex items-center justify-between">
          ...
          {onAIGen && (
            ...
            >
              {isGenerating ? <Loader2 className="w-3 h-3 animate-spin" /> : <Wand2 className="w-3 h-3 text-purple-500" />} AI Gen
            </button>
          )}
        </div>
        {description && (
          <p className={`text-[11px] pl-1 pr-1 leading-relaxed ${theme.group === 'Dark' ? 'text-white/35' : 'text-slate-500'} italic`}>
            {description}
          </p>
        )}
      </div>
      <textarea
        ref={textareaRef}
        rows={1}
        value={typeof localValue === 'string' ? localValue.replace(/<br\s*\/?>/gi, '\n') : localValue}
      ...
      <div className="space-y-4">
        {arr.map((item, i) => (
          <div key={i} className={`p-4 rounded-xl border flex flex-col gap-3 ${theme.group === 'Dark' ? 'bg-white/5 border-white/10' : 'bg-white/80 border-black/10 shadow-sm'}`}>
            <div className="flex gap-3">
              <div className="flex-[2]">
                <CharacterInput label="Họ và tên nhân vật" value={item.name || ''} onChange={(val) => {
                  const newArr = [...arr];
                  newArr[i] = { ...newArr[i], name: val };
                  onChange(newArr);
                }} />
              ...
              <div className="flex-[1.5]">
                 <CharacterInput label="Tình trạng" value={item.status || ''} onChange={(val) => {
                  const newArr = [...arr];
            ...
            <div className="flex gap-3">
              <div className="flex-[2]">
                <CharacterInput label="Ấn tượng và suy nghĩ" value={item.impression || ''} onChange={(val) => {
                  const newArr = [...arr];
              ...
              <div className="flex-1">
                 <CharacterInput label="Cách xưng hô (cách nhau bởi phẩy)" value={Array.isArray(item.termsOfAddress) ? item.termsOfAddress.join(', ') : (item.termsOfAddress || '')} onChange={(val) => {
                  const newArr = [...arr];
                  newArr[i] = { ...newArr[i], termsOfAddress: val.split(',').map(s => s.trim()).filter(s => s) };
                  onChange(newArr);
                }} />
              </div>
            </div>
